<x-main-layout>
    ...
    <div class="flex flex-row w-full items-center justify-start gap-2 my-4 p-2">
        ...
        <div class="flex flex-col w-full gap-y-0">
            <h1 class="font-bold color-slate-300">{{$tenant->name}}</h1>
            <span class="text-[10px]">{{ $tenant->description }}</span>
        </div>
        <span class="text-[10px] bg-purple-500 rounded-md mt-4 p-1 w-[200px] text-center">CODE: {{ $tenant->code }}</span>
    </div>
    <div class="tabs tabs-lift items-center justify-around">
